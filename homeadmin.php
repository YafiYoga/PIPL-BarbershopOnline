...
<body>
  <div class="container">
    ...
    <div class="content">
        ...
        <tbody>
          ...
          while ($tampil = mysqli_fetch_array($ambildata)){
            ...
            <tr>
              ...
              <td>$tampil[namalayanan]</td>
              <td>$tampil[harga]</td>
              <td>$tampil[jenislayanan]</td>
              <td><a href='?kode=$tampil[id_layanan]'>delete</a></td>
            </tr>
            ";
          }
          ?>
      ...
      <?php
      if(isset($_GET['kode'])){
        mysqli_query($connection, "delete from layanan where kode='$_GET[kode]'");
      }
      ?>
    </div>
  </div>
